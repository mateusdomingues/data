...
fist = getPlayerSkillLevel(item2.uid,0)
club = getPlayerSkillLevel(item2.uid,1)
sword = getPlayerSkillLevel(item2.uid,2)
axe = getPlayerSkillLevel(item2.uid,3)
distance = getPlayerSkillLevel(item2.uid,4)
shield = getPlayerSkillLevel(item2.uid,5)
fish = getPlayerSkillLevel(item2.uid,6)
