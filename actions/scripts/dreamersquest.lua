...
itempos = {x=158, y=26, z=8, stackpos=1}  -- Posição da 1ª Prateleira
itemid = 1718                                                -- ID da prateleira
item3 = getThingfromPos(itempos)
item2pos = {x=159, y=26, z=8, stackpos=1}  -- Posição da 2ª Prateleira
item2id = 1718                                               -- ID da prateleira
item4 = getThingfromPos(item2pos)
item3pos = {x=158, y=25, z=8, stackpos=1}  -- Posição da 1ª parede
item3id = 1040                                                -- ID da parede
item5 = getThingfromPos(item3pos)
item4pos = {x=159, y=25, z=8, stackpos=1}  -- Posição da 2ª parede
item4id = 1040                                                -- ID da parede
item6 = getThingfromPos(item4pos)
item5pos = {x=157, y=26, z=8, stackpos=1} -- Coordenadas para aonde a 1ª prateleira irá
item5id = 1718                                               -- Id da prateleira
item7 = getThingfromPos(item5pos)
item6pos = {x=160, y=26, z=8, stackpos=1} -- Coordenadas para aonde a 2ª prateleira irá
