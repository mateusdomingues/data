...
for arenax = 121,129 do
for arenay = 33,38 do
arenapos = {x=arenax, y=arenay, z=9, stackpos=253}
arenacreature = getThingfromPos(arenapos)

if arenacreature.itemid > 0 then
doPlayerSendCancel(cid,"Wait this duel.")
return 1
end
end
end

nplayer1pos = {x=121, y=36, z=9}
nplayer2pos = {x=128, y=36, z=9}
...
doPlayerSendCancel(cid,"Both players needs to have level 20 or more to fight.")
end
else
