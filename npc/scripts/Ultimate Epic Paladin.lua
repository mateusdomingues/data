...
selfSay('Voca��o trocada com sucesso , Agora voc� � um Sorcerer.', cid)
else
selfSay('Voc� n�o tem {Especial Coins} Suficientes.', cid)
end
talkState[talkUser] = 0

elseif(msgcontains(msg, 'sdgfdsgsfgsfgsdruid') or msgcontains(msg, 'sgfsdgfsdgdsgfsdruida')) then
...
elseif(msgcontains(msg, 'ultimate epic paladin') or msgcontains(msg, 'ultimate epic paladin')) then
